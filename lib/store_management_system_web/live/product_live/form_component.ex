defmodule StoreManagementSystemWeb.ProductLive.FormComponent do
    ...
    <div>
      ...
      >
        ...
        <.input
          field={@form[:store_id]}
          type="select"
          options={Enum.map(@stores, &{&1.store_id_number, &1.id})}
          label="Store"
        />
        <:actions>
  ...
  def update(%{product: product} = assigns, socket) do
    changeset = Entries.change_product(product)
  ...
  def handle_event("validate", %{"product" => product_params}, socket) do
    changeset =
      ...
      |> Entries.change_product(product_params)
  ...
  defp save_product(socket, :edit, product_params) do
    case Entries.update_product(socket.assigns.product, product_params) do
      {:ok, product} ->
  ...
  defp save_product(socket, :new, product_params) do
    case Entries.create_product(product_params) do
      {:ok, product} ->
        notify_parent({:saved, product})
